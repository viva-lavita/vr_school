...
export default function NotFound() {
  return (
    <div className="relative flex flex-col items-center md:items-start text-center md:text-left gap-[40px] pt-[40px] px-[16px] pb-0 md:p-[40px] lg:p-15 min-[1920px]:px-[120px]! min-[1920px]:py-[80px]! bg-black mt-12 mb-20 rounded-4xl overflow-hidden">
