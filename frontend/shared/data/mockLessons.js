...
const chemistryLessons = [
  {
    ...
    status: "new",
    sub_description:
      "Урок «Погружение в строение атома» знакомит учащихся с основами строения вещества.\n\nВ VR-среде школьники изучат строение атома, рассмотрят протоны, нейтроны и электроны, а также узнают, как количество протонов влияет на химический элемент. Во время занятия учащиеся смогут взаимодействовать с 3D-моделью атома, собирать его из элементарных частиц и наблюдать расположение электронов на оболочках. VR-формат помогает наглядно представить процессы, которые невозможно увидеть в обычной лаборатории.\n\nПроверочное задание включает определение состава атома, сборку модели химического элемента и поиск ошибок в виртуальной модели.",
    video: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    is_need_vpn: true,
    test_comment:
      "При выполнении задания важно правильно определить количество протонов, нейтронов и электронов в атоме. Обратите внимание: именно число протонов определяет химический элемент. Для успешного прохождения задания рекомендуется внимательно изучить VR-модель атома и проследить расположение частиц внутри него.",
    tests: [
      {
        id: 1,
        name: "Тест по теме: «Строение атома» (VR-урок 1)",
        status: "new",
        questions: [
          {
            id: 1,
            type: "radio",
            question: "Какая частица определяет химический элемент?",
            options: ["Протон", "Нейтрон", "Электрон", "Фотон"],
            optionIds: [10, 11, 12, 13],
          },
          {
            id: 2,
            type: "checkbox",
            question: "Какие частицы входят в состав атомного ядра?",
            hint: "В данном задании можно выбрать несколько вариантов ответа",
            options: ["Протоны", "Нейтроны", "Электроны", "Позитроны"],
            optionIds: [20, 21, 22, 23],
          },
          {
            id: 3,
            type: "text",
          ...
          },
          {
            ...
            hint: "Перетащите названия частиц к их характеристикам",
            labels: ["Не имеет электрического заряда", "Имеет положительный заряд", "Имеет отрицательный заряд"],
            tags: ["Протон", "Электрон", "Ион"],
          },
          {
            id: 5,
            type: "matching",
            question: "Распределите характеристики",
            hint: "Перетащите все подходящие характеристики. Внимание! Каждому лейблу может соответствовать несколько тэгов!",
            multi: true,
            labels: ["Протон", "Электрон", "Нейтрон"],
            tags: ["Находится в ядре", "Не имеет заряда", "Движется внутри ядра", "Отрицательный заряд", "Не имеет заряда", "Положительный заряд"],
          },
          {
            id: 6,
            type: "essay",
            question: "Опишите строение атома водорода. Какие частицы входят в его состав?",
            max_length: 5000,
          },
        ],
      },
